...
class AppLocalizations {
  ...
  static const _localizedValues = {
    'ar': {
      ...
      'create_collection': 'إنشاء قائمة',
      'add_to_collection': 'أضف إلى قائمة',
      'rename': 'إعادة تسمية',
      'delete_collection': 'حذف القائمة',
      ...
      'share_summary': 'نسخ ملخّص',
      'undo': 'رجوع',
      'compare_limit': 'يمكنك مقارنة حتى 3 عناصر',
    ...
    'en': {
      ...
      'undo': 'Undo',
      'compare_limit': 'You can compare up to 3 items',
      'brand': 'Brand',
      'theme_style': 'Theme',
